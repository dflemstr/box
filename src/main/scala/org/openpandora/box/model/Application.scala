...
object Application {
  def apply(`package`: Package, versionMajor: Int, versionMinor: Int, versionRelease: Int, versionBuild: Int, authorName: Option[String]): Application = {
    ...
    Application(`package`.id, versionMajor, versionMinor, versionRelease, versionBuild, authorName)
  }
}