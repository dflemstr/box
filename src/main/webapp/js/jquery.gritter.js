...
(function($){
	...
	*/
	$.gritter.options = {
		fade_in_speed: 'slow', // how fast notifications fade in
	...
	var Gritter = {
		...
		*/
		add: function(params){
			...
			$('#notifications-wrapper').append(tmp);
			
			var item = $('#notification-' + this._item_count);
		...
		*/  
		stop: function(params){
			...
			var wrap = $('#notifications-wrapper');
			before_close(wrap);
		...
		*/  
		_verifyWrapper: function(){
			...
			if($('#notifications-wrapper').length == 0){
